...
// runtime. You can call Go functions directly using the @pola/actions bridge.
//
// Actions are defined in the actions/ directory. Each Go struct becomes
// a named export: import { Server } from "@pola/actions"
...
async function Greeting() {
  const { message } = await Server.greet("fumadocs-docs");
    ...
    <div>
      <div style={{ padding: "4rem 0 2rem" }}>
        <h1 style={{ fontSize: "2.5rem", fontWeight: 800, letterSpacing: "-0.02em" }}>
          Welcome to <span style={{ color: "var(--color-accent)" }}>fumadocs-docs</span>
        </h1>
