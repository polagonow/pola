  ...
  return (
    <div>
      <div className="detail-header">
        ...
        <h1 style={{ fontSize: "2rem", fontWeight: 800, lineHeight: 1.2 }}>{post.title}</h1>
      ...
      <div className="card" style={{ marginBottom: "1.5rem" }}>
        <p style={{ color: "var(--muted)", fontSize: ".9rem" }}>
          <em>Full content would go here. This is a framework demo — the post body is not stored in the bridge data.</em>
        </p>
      </div>
