  ...
  return (
    <div>
      ...
      <p style={{ color: "var(--muted)", lineHeight: 1.7, marginBottom: "1.5rem", maxWidth: "560px" }}>
        DevBlog is a framework showcase built with <strong>GoJSX</strong> — a Go-powered React SSR
        framework that runs Server Components inside a Goja VM and streams them via the Flight wire protocol.
      </p>

      <div className="card" style={{ marginBottom: "1rem" }}>
        <h2 style={{ fontSize: "1rem", fontWeight: 600, marginBottom: ".75rem" }}>Framework stack</h2>
      ...
      <div className="card">
        <h2 style={{ fontSize: "1rem", fontWeight: 600, marginBottom: ".75rem" }}>Features demonstrated</h2>
        <ul style={{ fontSize: ".9rem", lineHeight: 2, color: "var(--muted)", paddingLeft: "1.25rem" }}>
          <li>Async Server Components with <code>Suspense</code></li>
          <li>Nested layouts at every route segment</li>
          <li>Route groups — <code>(blog)</code> and <code>(work)</code></li>
          ...
          <li>Dynamic routes with <code>[slug]</code> and <code>[id]</code></li>
          <li>Go ↔ JS bridge (<code>jsi</code>)</li>
