...
func TestErrorBoundary_Home(t *testing.T) {
	forEachReactApp(t, func(t *testing.T, f AppFixture) {
		assertCorrectErrorBoundary(t, RSC(t, f, "/?error=test-error"), `"app/error"`)
	})
}

func TestErrorBoundary_Posts(t *testing.T) {
	forEachReactApp(t, func(t *testing.T, f AppFixture) {
		assertCorrectErrorBoundary(t, RSC(t, f, "/posts?error=test-error"), `"app/(blog)/posts/error"`)
	})
}

func TestErrorBoundary_Projects(t *testing.T) {
	forEachReactApp(t, func(t *testing.T, f AppFixture) {
		assertCorrectErrorBoundary(t, RSC(t, f, "/projects?error=test-error"), `"app/(work)/projects/error"`)
	})
}

func TestErrorBoundary_ProjectDetail(t *testing.T) {
	forEachReactApp(t, func(t *testing.T, f AppFixture) {
		assertCorrectErrorBoundary(t, RSC(t, f, "/projects/1?error=test-error"), `"app/(work)/projects/[id]/error"`)
	})
}

func TestErrorBoundary_About(t *testing.T) {
	forEachReactApp(t, func(t *testing.T, f AppFixture) {
		assertCorrectErrorBoundary(t, RSC(t, f, "/about?error=test-error"), `"app/about/error"`)
	})
}

func TestErrorBoundary_Profile(t *testing.T) {
	forEachReactApp(t, func(t *testing.T, f AppFixture) {
		assertCorrectErrorBoundary(t, RSC(t, f, "/profile?error=test-error"), `"app/profile/error"`)
	})
}

func TestErrorBoundary_PostDetail(t *testing.T) {
	forEachReactApp(t, func(t *testing.T, f AppFixture) {
		assertCorrectErrorBoundary(t, RSC(t, f, "/posts/go-react-ssr?error=test-error"), `"app/(blog)/posts/[slug]/error"`)
	})
}
...
func TestErrorBoundary_Revisions(t *testing.T) {
	forEachReactApp(t, func(t *testing.T, f AppFixture) {
		assertCorrectErrorBoundary(t,
			RSC(t, f, "/posts/go-react-ssr/revisions?error=test-error"),
...
func TestErrorBoundary_RevisionDetail(t *testing.T) {
	forEachReactApp(t, func(t *testing.T, f AppFixture) {
		assertCorrectErrorBoundary(t,
			RSC(t, f, "/posts/go-react-ssr/revisions/v1?error=test-error"),
...
func TestErrorBoundary_Docs(t *testing.T) {
	forEachReactApp(t, func(t *testing.T, f AppFixture) {
		assertCorrectErrorBoundary(t, RSC(t, f, "/docs?error=test-error"), `"app/docs/[[...slug]]/error"`)
	})
}
