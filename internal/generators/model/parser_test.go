...
func TestParseArgs_Basic(t *testing.T) {
	...
	tests := []struct {
		...
		{"title", schema.FieldString},
		{"body", schema.FieldText},
		{"published", schema.FieldBool},
	}
...
func TestParseArgs_References(t *testing.T) {
	...
	if def.Fields[0].Type != schema.FieldReferences {
		t.Errorf("type = %q, want %q", def.Fields[0].Type, schema.FieldReferences)
	}
...
func TestParseArgs_PolymorphicReferences(t *testing.T) {
	...
	if f.Type != schema.FieldReferences {
		t.Errorf("type = %q, want %q", f.Type, schema.FieldReferences)
	}
	if !f.Polymorphic {
...
func TestModelDefinition_HasReferences(t *testing.T) {
...
func TestModelDefinition_HasReferences_PolymorphicOnly(t *testing.T) {
	def := &schema.ModelDefinition{
		Name: "Comment",
		Fields: []schema.Field{
...
func TestModelDefinition_HasIndexes(t *testing.T) {
	def := &schema.ModelDefinition{
		Name: "User",
		Fields: []schema.Field{
