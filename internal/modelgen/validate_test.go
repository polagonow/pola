...
`
	...
	if def.Fields[0].RefIDType != FieldInt {
		t.Errorf("RefIDType = %q, want %q", def.Fields[0].RefIDType, FieldInt)
	}
}
...
`
	...
	if def.Fields[0].RefIDType != FieldUUID {
		t.Errorf("RefIDType = %q, want %q", def.Fields[0].RefIDType, FieldUUID)
	}
}
...
`
	...
	if def.Fields[0].RefIDType != FieldInt64 {
		t.Errorf("RefIDType = %q, want %q", def.Fields[0].RefIDType, FieldInt64)
	}
}
