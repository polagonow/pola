// Open Graph image generation. Vendored and adapted from rari (rari/og).
//
// ImageResponse is a pure serializer: it walks a React element tree into a
// JSON-serializable description, with no runtime coupling. It does NOT rasterize
// to PNG itself — a backend renderer consumes the toJSON() output and produces
// the image.
//
// BACKEND CONTRACT (Pola follow-up): a Go OG endpoint should accept the toJSON()
// shape and return an image:
//
//   { type: "ImageResponse",
//     element: <serialized tree>,
//     options: { width, height } }
//
//   serialized tree node, one of:
//     { type: "text",    value: string }
//     { type: "element", elementType: string, props: {...}, children: [...] }
//
// Pola currently renders OpenGraph <meta> tags (see core/metadata.go) but has no
// React->PNG rasterizer; wiring a satori-style Go renderer is tracked separately.
