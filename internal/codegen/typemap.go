...
// TSType converts a Go types.Type to its TypeScript representation for use
// in method signatures (PolaActions interface). Struct types are referenced
// by name — the actual interface definitions are generated by typescriptify.
